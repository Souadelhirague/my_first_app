...
<div class="container">
<form  id="add-sale" action="{{route('sales.store')}}" method="Post"enctype="multipart/form-data">
@csrf
...
<div class="d-flex flex-column justify-content-center align-items-center">
    ...
    <span>
        Rue awatif el kelaa des sraghna
    </span>
    <span>
        0543378565
    </span>
...
<a href="{{route('sales.edit',$sale->id)}}" class="mr-1 btn btn-sm btn-warning ">
...
<i class="fa fa-print fa-2x"></i>
       ...
       <div class="row justify-content-center mt-2">
         ...
         <ul class="nav nav-pills mb-3"id="pills-tab"role="table">
           ...
           <div class="col-md-4 mb-2">
               <div class="card h-100">
                 <div class="card-body 
                    ...
                    align-items-center">
          <div class="align-self-end">
                <input type="checkbox" name="menu_id[]" id="menu-id"
                value="{{$menu->id}}">
              </div>  
 ...
 <input type="number" name="total_price" class="form-control"id="total_price" placeholder="Prix" >
 ...
 <input type="number" name="total_received" class="form-control" id="total_received"placeholder="Total">
 <div class="input-group-append">
 <div class="input-group-text">
    .00
  </div>
   ...
   <input type="number" name="change" class="form-control" id="change" placeholder="Reste">
   <div class="input-group-append">
 <div class="input-group-text">
    .00
     </div>
