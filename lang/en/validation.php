...
return [
    ...
    */
    ...
    'custom' => [
        ...
        // ],
        'title'=>[
    'required'=>'le titre est vide veuillez saisir.',
    'min'=>'le titre doit avoir au moins trois caractéres',
    'unique'=>'le titre déja existe'],
    'image'=>[
'required'=>'le champ image est obligatoire',
'image'=>'le fichier n\'est pas valide',
'mimes'=>'Seuls les fichiers : :values sont accéptés',
'uploaded'=>'la taille d\'image ne doit pas dépasser :max kilobytes',

    ],
    'description'=>[
        'required'=>'le champ description est obligatoire',
        'min'=>'le champ description doit avoir au moins cinq caractéres',
 ...
 'total_received'=>[
    ...
    'total_status'=>[
        'required'=>'le champ status de paiement est obligatoire',        
            ],
'payment_type'=>[
...
'table_id'=>[
 ...
 'change'=>[
        'required'=>'le champ rest est obligatoire',        
            ],    
 'from'=>[
...
//     'required'=>'le titre est vide veuillez saisir.',
//     'min'=>'le titre doit avoir au moins trois caractéres',
//     'unique'=>'le titre sisai est déja existe',
// ]
